⚠️ This is fork of the https://github.com/ionic-team/ionic-plugin-deeplinks repository that has been archived on August 2023 in favor of Capacitor.

However, the plugin stopped working on Android 12+ devices, so we forked it to fix the compatibility issue.

 We do not recommend using this plugin if you are currently considering a deep linking solution using a Cordova stack. 
Look at [branchio](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking-attribution) instead. 

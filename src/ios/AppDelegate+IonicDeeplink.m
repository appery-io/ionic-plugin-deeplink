...
/**
 *  Category for CDVAppDelegate (cordova-ios 8+) that overrides openURL / continueUserActivity,
 *  so we could handle application launch when user clicks on the link in the browser.
 */
@interface CDVAppDelegate (IonicDeeplinkPlugin)
...
@implementation CDVAppDelegate (IonicDeeplinkPlugin)
